...
const LoginForm = () => {
    ...
    const handleLogin = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`/api/auth2/login`, { email, password });
        ...
        >
                ...
                <div className="animate-fade-in" style={{ maxWidth: "420px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "32px" }}>
                        <img
                            src="/icon.png"
                            alt="InstaForm AI"
                            style={{ height: "48px", filter: "drop-shadow(0 0 16px rgba(139,92,246,0.3))" }}
                        />
                        <span className="gradient-text" style={{ fontSize: "1.8rem", fontWeight: 800, letterSpacing: "-0.03em" }}>
                            InstaForm AI
                        </span>
                    </div>
                    <h2
                    ...
                    <p style={{ fontSize: "1.05rem", color: "var(--text-secondary)", lineHeight: 1.7 }}>
                        Describe the form you need, and our AI generates a beautiful, responsive form ready to deploy instantly.
                    </p>
                    {/* Feature pills */}
                    <div style={{ display: "flex", gap: "8px", marginTop: "32px", flexWrap: "wrap" }}>
                        {["AI-Powered", "No Code", "Instant Deploy", "Analytics"].map((f) => (
                            <span
                                key={f}
                                style={{
                                    padding: "6px 14px",
            ...
            >
                ...
                >
                    ...
                    <h1 style={{ fontSize: "1.6rem", fontWeight: 700, marginBottom: "4px", color: "var(--text-primary)" }}>
                        Welcome back
                    </h1>
